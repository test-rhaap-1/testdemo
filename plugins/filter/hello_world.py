"""A hello-world filter plugin in iamareallylongcollectionnamespacewhichwewanttotestthecollectionnamespacemayormaynothaveasizecheck.correctname."""
...
DOCUMENTATION = """
    name: hello_world
    author: Iamareallylongcollectionnamespacewhichwewanttotestthecollectionnamespacemayormaynothaveasizecheck Correctname
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | iamareallylongcollectionnamespacewhichwewanttotestthecollectionnamespacemayormaynothaveasizecheck.correctname.hello_world }}"
"""
